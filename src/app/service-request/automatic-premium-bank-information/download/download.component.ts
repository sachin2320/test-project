...
@Component({
    selector: 'automatic-premium-bank-information-download',
    styles: [],
    templateUrl: './download.component.html'
})

export class ServiceRequestAutomaticPremiumBankInformationDownloadComponent implements OnInit {
    ...
    SetBodyValues() {
        ...
        this.dataItems.push(new KeyValueModel('2. ' + this.utility.getConfigText('SR_download_automaticPremiumBankInformation_complForm_title') + '', this.utility.getConfigText('SR_download_common_complFinancialInstitution_value')));
        this.dataItems.push(new KeyValueModel('3. ' + this.utility.getConfigText('SR_offline_common_signature_title') + '', this.utility.getConfigText('SR_download_common_signatureAccountHolder_value')));
    ...
    SetEmailFaxBodyValues() {
        this.emailFaxDataItems.push(new KeyValueModel((this.dataItems.length + 1).toString() + ". " + this.utility.getConfigText("SR_offline_common_3to5daysToProcess_title") + "", this.utility.getConfigText("SR_offline_common_3to5daysToProcessInGoodOrder_value")));
        this.emailFaxDataItems.push(new KeyValueModel((this.dataItems.length + 2).toString() + '. ' + this.utility.getConfigText('SR_offline_common_confirmation_title') + '', this.utility.getConfigText('SR_download_common_confirmationToOwner_value')));
    }
