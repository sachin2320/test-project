...
@Component({
    selector: 'change-address-offline',
    styles: [],
    templateUrl: './offline.component.html'
})

export class ServiceRequestAddressChangeOfflineComponent implements OnInit {
    ...
    SetBodyValues() {
        ...
        this.dataItems.push(new KeyValueModel("2. " + this.utility.getConfigText("SR_offline_common_complForm_title") + "", this.utility.getConfigText("SR_offline_chng_address_complForm_value")));
