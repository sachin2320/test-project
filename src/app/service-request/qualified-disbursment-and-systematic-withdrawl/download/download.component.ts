...
@Component({
    selector: 'qualified-disbursement-systematic-withdrawl-download',
    styles: [],
    templateUrl: './download.component.html'
})

export class ServiceRequestQualifiedDisbursementAndSystematicWithdrawlDownloadComponent implements OnInit {
    ...
    SetBodyValues() {
        ...
        this.dataItems.push(new KeyValueModel("2. " + this.utility.getConfigText("SR_offline_common_complForm_title") + "", this.utility.getConfigText("SR_download_common_complRequestDistribution_value")));
        this.dataItems.push(new KeyValueModel("3. " + this.utility.getConfigText("SR_download_disbursement_surrender_title") + "", this.utility.getConfigText("SR_download_disbursement_qualified_annuity_surrender_value")));
        this.dataItems.push(new KeyValueModel("4. " + this.utility.getConfigText("SR_offline_common_signature_title") + "", this.utility.getConfigText("SR_download_disbursement_qualified_annuity_surrender_signature_value")));
    ...
    SetEmailFaxBodyValues() {
        this.emailFaxDataItems.push(new KeyValueModel((this.dataItems.length + 1).toString() + ". " + this.utility.getConfigText("SR_download_disbursement_qualified_annuity_daysToProcess_title") + "", this.utility.getConfigText("SR_download_disbursement_qualified_annuity_daysToProcess_value")));
        this.emailFaxDataItems.push(new KeyValueModel((this.dataItems.length + 2).toString() + ". " + this.utility.getConfigText("SR_offline_common_confirmation_title") + "", this.utility.getConfigText("SR_download_common_confirmationToOwnerCheckMailed_value")));
    }
