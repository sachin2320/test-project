...
@Component({
    selector: 'life-loan-download',
    styles: [],
    templateUrl: './download.component.html'
})

export class ServiceRequestLifeLoanDownloadComponent implements OnInit {
    ...
    SetBodyValues() {
        ...
        this.dataItems.push(new KeyValueModel("2. " + this.utility.getConfigText("SR_offline_common_complForm_title") + "", this.utility.getConfigText("SR_download_lifeloan_complForm_value")));
