...
@Component({
    selector: 'disbursement-life-insurance-download',
    styles: [],
    templateUrl: './download.component.html'
})

export class ServiceRequestDisbursementLifeInsuranceDownloadComponent implements OnInit {
    ...
    SetBodyValues() {
        ...
        this.dataItems.push(new KeyValueModel("2. " + this.utility.getConfigText("SR_offline_common_complForm_title") + "", this.utility.getConfigText("SR_download_disbursement_complForm_value")));
    ...
    SetEmailFaxBodyValues() {
        this.emailFaxDataItems.push(new KeyValueModel((this.dataItems.length + 1).toString() + ". " + this.utility.getConfigText("SR_offline_common_daysToProcess_title") + "", this.utility.getConfigText("SR_download_fullOrPartialSurrender_daysToProcess_Value")));
        this.emailFaxDataItems.push(new KeyValueModel((this.dataItems.length + 2).toString() + ". " + this.utility.getConfigText("SR_offline_common_confirmation_title") + "", this.utility.getConfigText("SR_download_disbursement_confirmationToOwner_value")));
    }
